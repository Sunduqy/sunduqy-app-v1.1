        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="inline-block max-h-screen bg-white rounded-lg text-start overflow-hidden shadow-xl transform transition-all my-8 align-middle w-full max-w-md p-8 lg:m-0 m-3">
                ...
                <div className='flex flex-col items-center p-2 py-4 gap-2 mb-6'>
                    <div className='p-3 bg-dark-blue rounded-2xl justify-center items-center'>
                    ...
                    <a href='/create-rocket-post' className='rounded-2xl items-center justify-center bg-dark-blue p-4 mt-4 hover:bg-opacity-80'>
                ...
                <div className='flex flex-col items-center p-2 py-4 gap-2 mt-6'>
                    ...
                    <a href='/create-post' className='rounded-2xl items-center justify-center bg-dark-blue p-4 mt-4 hover:bg-opacity-80'>
