                            ...
                            <div className='h-130 overflow-y-auto no-scrollbar'>
                                <div className='space-y-4 p-4'>
                                    <div>
                                        ...
                                        <div className={`flex border rounded-2xl overflow-hidden shadow-sm focus:outline-none mt-1 p-3 ${invalidInput ? 'bg-red-200 border-red-600' : 'bg-border-lighter-blue'}`}>
                                    ...
                                    <div>
                                        ...
                                        <div className={`flex border rounded-2xl overflow-hidden shadow-sm focus:outline-none mt-1 p-3 justify-between ${invalidInput ? 'bg-red-200 border-red-600' : 'bg-border-lighter-blue'}`}>
                                            <input
                                                type='email'
                                    ...
                                    <div>
                                        ...
                                        <div className={`flex border rounded-2xl overflow-hidden shadow-sm focus:outline-none mt-1 p-2.5 justify-between ${invalidInput ? 'bg-red-200 border-red-600' : 'bg-border-lighter-blue'}`}>
                                            <input
                                ...
                                <form onSubmit={handleForgotPassword}>
                                    <div>
                                        <div>
                                            ...
                                            <div className='flex border rounded-2xl overflow-hidden shadow-sm focus:outline-none mt-1 p-3 bg-border-lighter-blue justify-between'>
                                                <input
                                                    type='email'
                                                    value={email}
                                        ...
                                        <div>
                                            <button type='submit' className='w-full rounded-2xl items-center justify-center bg-dark-blue p-4 mt-4 hover:bg-opacity-80'>
