            ...
            >
                ...
                >
                    ...
                    <div className='flex flex-col justify-start gap-3 items-start p-4'>
                        {user ? (
                            <a href="/account-settings" className="flex flex-row justify-center items-start gap-2 px-4 py-2 rounded-2xl bg-dark-blue bg-opacity-10">
                            ...
                            <button onClick={toggleRegistrationModal} className="flex flex-row justify-center items-center gap-2 px-4 py-2 rounded-2xl bg-dark-blue">
                        ...
                        <button onClick={!user ? toggleRegistrationModal : toggleCreateAdModal} className="flex flex-row justify-center items-center gap-2 px-4 py-2 rounded-2xl bg-dark-blue">
                        ...
                        {user && (
                            <button onClick={toggleSignOutModal} className="flex flex-row justify-center items-center gap-2 px-4 py-2 rounded-2xl bg-dark-blue">
